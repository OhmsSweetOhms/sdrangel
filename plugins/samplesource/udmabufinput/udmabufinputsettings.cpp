...
const unsigned int UdmaBufInputSettings::m_accelerationMaxScale = 2;

UdmaBufInputSettings::UdmaBufInputSettings()
{
    resetToDefaults();
}

void UdmaBufInputSettings::resetToDefaults()
{
    m_title = "UdmaBufInput";
    m_fileName = "";
...
QByteArray UdmaBufInputSettings::serialize() const
{
...
bool UdmaBufInputSettings::deserialize(const QByteArray& data)
{
    ...
    if (d.getVersion() == 1)
    {
        ...
        d.readString(8, &m_title, "UdmaBufInput");
...
int UdmaBufInputSettings::getAccelerationIndex(int accelerationValue)
{
...
int UdmaBufInputSettings::getAccelerationValue(int accelerationIndex)
{
...
void UdmaBufInputSettings::applySettings(const QStringList& settingsKeys, const UdmaBufInputSettings& settings)
{
...
QString UdmaBufInputSettings::getDebugString(const QStringList& settingsKeys, bool force) const
{
